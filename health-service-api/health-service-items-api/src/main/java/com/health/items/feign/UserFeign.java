...
public interface UserFeign {
    ...
    Result<PageInfo> findPage(@RequestBody(required = false) User user, @PathVariable(name = "page")  int page
     ...
     */
    @PutMapping(value="/{id}")
    Result update(@RequestBody User user,@PathVariable(name = "id") Integer id);
     ...
     */
    @GetMapping("/{id}")
    Result<User> findById(@PathVariable(name = "id") Integer id);
    ...
    Result<User> findByUsername(@PathVariable String name);
}
