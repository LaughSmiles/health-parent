...
import com.health.items.dao.MenuMapper;
import com.health.items.pojo.Menu;
import com.health.items.service.MenuService;
    ...
    public Example createExample(Menu menu){
        ...
        if(menu!=null){
            ...
            if(!StringUtils.isEmpty(menu.getLinkUrl())){
                    criteria.andEqualTo("linkUrl",menu.getLinkUrl());
            }
            //
            if(!StringUtils.isEmpty(menu.getPath())){
                    criteria.andEqualTo("path",menu.getPath());
            }
            //
            if(!StringUtils.isEmpty(menu.getPriority())){
                    criteria.andEqualTo("priority",menu.getPriority());
            }
            //
            ...
            if(!StringUtils.isEmpty(menu.getDescription())){
                    criteria.andEqualTo("description",menu.getDescription());
            }
            //
            if(!StringUtils.isEmpty(menu.getParentMenuId())){
                    criteria.andEqualTo("parentMenuId",menu.getParentMenuId());
            }
            //
