...
import com.health.items.dao.PermissionMapper;
    ...
    public Example createExample(Permission permission){
        ...
        if(permission!=null){
            ...
            if(!StringUtils.isEmpty(permission.getKeyword())){
                    criteria.andEqualTo("keyword",permission.getKeyword());
            }
            //
            if(!StringUtils.isEmpty(permission.getDescription())){
                    criteria.andEqualTo("description",permission.getDescription());
            }
        }
        return example;
    }
